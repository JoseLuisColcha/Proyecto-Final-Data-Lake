...
###API ########################
ckey = "UkRHKMJvO7RlhsWJn4RsZCWVx"
csecret = "XO4x1MwnXNg29IDSrq8m7zlAXuTaRy46wq2z6j4DqIRrxtCHxt"
atoken = "1340168707704823808-HKap2vj8HCeQXFxXt2FIwOfaBfwBf3"
asecret = "uiKvTBMvFMH4emGSKgXTTql1G3pm3Adu1426FqvF3Gj55"
#####################################
...
'''========couchdb'=========='''
server = couchdb.Server('http://Jose Luis Colcha:1723547624@localhost:5984/') 
try:
...
#Filtro por palabras
#twitterStream.filter(track=['Elecciones Ecuador 2021','Pulso Politico','Elecciones 2021','Candidatos 2021','Candidatos presidenciales','candidatos a presidentes','Votaciones','voto electoral', 'votaciones 2021','Guillermo Lasso','Andres Arauz','Yaku Perez'])
